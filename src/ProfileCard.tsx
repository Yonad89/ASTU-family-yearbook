...
// Custom theme gradient matching dark navy and orange accent
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(234, 88, 12, 0.25) 0%, rgba(10, 15, 29, 0.95) 100%)';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--behind-glow-color': behindGlowColor ?? 'rgba(234, 88, 12, 0.45)',
      ...
      '--sunpillar-1': 'hsl(24, 100%, 55%)',
      '--sunpillar-2': 'hsl(35, 100%, 60%)',
      '--sunpillar-3': 'hsl(15, 90%, 50%)',
      '--sunpillar-4': 'hsl(215, 60%, 45%)',
      '--sunpillar-5': 'hsl(225, 70%, 25%)',
      '--sunpillar-6': 'hsl(25, 95%, 53%)',
  ...
  const shineStyle = {
    ...
    filter: 'brightness(0.66) contrast(1.33) saturate(0.5) opacity(0.35)',
  ...
  return (
    ...
    >
      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
          className="grid relative overflow-hidden border border-amber-500/20 shadow-2xl"
          style={{
            height: '80svh',
            maxHeight: '520px',
            aspectRatio: '0.718',
            ...
            boxShadow: '0 20px 40px -15px rgba(0,0,0,0.8), 0 0 20px 0 rgba(234, 88, 12, 0.15)',
  ...
  <div className="absolute inset-0 overflow-hidden" style={{ borderRadius: cardRadius }}>
    ...
    />
              ...
              {showUserInfo && (
                <div
                  className="absolute z-[2] flex items-center justify-between backdrop-blur-xl border border-amber-500/20 pointer-events-auto"
                  style={
                    {
                      '--ui-inset': '16px',
                      '--ui-radius-bias': '4px',
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className="rounded-full overflow-hidden border border-amber-500/30 flex-shrink-0"
                    ...
                    <div className="flex flex-col items-start gap-1">
                      <div className="text-sm font-semibold text-white leading-none">@{handle}</div>
                      <div className="text-xs text-amber-400/90 leading-none">{status}</div>
                    </div>
                  </div>
                  <button
                    className="border border-amber-500/40 rounded-lg px-3 py-2 text-xs font-semibold text-white bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-500 hover:to-orange-500 cursor-pointer transition-all duration-200 ease-out hover:shadow-lg hover:shadow-orange-600/30 hover:-translate-y-px"
              ...
              <div className="w-full absolute flex flex-col" style={{ top: '2.5em', display: 'flex', gridArea: 'auto' }}>
                <h3
                  ...
                  style={{
                    ...
                    backgroundImage: 'linear-gradient(to bottom, #ffffff, #f97316)',
                ...
                <p
                  ...
                  style={{
                    ...
                    fontSize: '14px',
                    margin: '0 auto',
                    backgroundImage: 'linear-gradient(to bottom, #fed7aa, #ea580c)',
                    backgroundSize: '1em 1.5em',
                    WebkitTextFillColor: 'transparent',
                    backgroundClip: 'text',
                    WebkitBackgroundClip: 'text',
